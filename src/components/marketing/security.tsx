...
const Security = () => {
  ...
  const localizedCertifications = t("security.certifications", certifications);
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium mb-1 group-hover:translate-x-1 transition-transform duration-300">
                      {t(`security.features.${feature.id}.title`)}
                    </h3>
                    <p className="text-muted-foreground">{t(`security.features.${feature.id}.description`)}</p>
                  </div>
                </div>
              </div>
            ))}
