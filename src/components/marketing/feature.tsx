  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      <g>
        ...
        <text x="55" y="85" textAnchor="middle" fontSize="20" fontFamily="monospace" fill="currentColor">T</text>
...
function FeatureCard({ feature, index }: { feature: typeof features[0]; index: number }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-16 py-12 lg:py-20 border-b border-foreground/10">
        {/* Number */}
        ...
        <div className="flex-1 grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-display mb-4 group-hover:translate-x-2 transition-transform duration-500">
              {t(`features.items.${feature.number}.title`)}
            </h3>
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              {t(`features.items.${feature.number}.description`)}
            </p>
          </div>
          
          {/* Visual */}
          <div className="flex justify-center lg:justify-end">
            <div className="w-44 h-36 md:w-48 md:h-40 text-foreground">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 className={`text-4xl lg:text-6xl font-display tracking-tight`}>
            ...
            <br />
            <span className="text-muted-foreground">{t("features.headingLine2")}</span>
          </h2>
        </motion.div>
